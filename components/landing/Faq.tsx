...
const faqs = [
  ...
  { q: 'Is there a free trial?', a: 'The Free plan is available forever with 1 project and 3 components. Pro and Business plans start with a 14-day free trial—no credit card required.' },
